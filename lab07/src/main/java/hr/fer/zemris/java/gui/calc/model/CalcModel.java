...
public interface CalcModel {
	...
	/**
	 * Postavljanje zamrznute vrijednosti prikaza.
	 * 
	 * @param value vrijednost prikaza
	 */
	void freezeValue(String value);
	
	/**
	 * Provjera postoji li zamrznuta vrijednost prikaza.
	 * 
	 * @return <code>true</code> ako postoji zamrznuta vrijednost prikaza, <code>false</code> inače
	 */
