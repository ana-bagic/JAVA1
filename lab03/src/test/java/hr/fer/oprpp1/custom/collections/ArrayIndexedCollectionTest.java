...
public class ArrayIndexedCollectionTest {
	...
	private ArrayIndexedCollection<Number> array;
	private ArrayIndexedCollection<Integer> array2;
	private ArrayIndexedCollection<String> array3;
	private ArrayIndexedCollection<String> array4;
	...
	public void testArrayCollectionConstructor() {
		array2 = new ArrayIndexedCollection<>(6);
		array2.add(1);
		array2.add(2);
		array2.add(3);
	...
	public void testArrayCollectionInitialCapacityBigConstructor() {
		...
		array2.add(2);
		array2.add(3);
		array = new ArrayIndexedCollection<>(array2, 10);
	...
	public void testArraySize4() {
		array3 = new ArrayIndexedCollection<>(10);
		array3.add("Oslo");
	...
	public void tesArraytAddReallocate() {
		array3 = new ArrayIndexedCollection<>(3);
		array3.add("Oslo");
		array3.add("Stockholm");
	...
	public void testArrayInsert() {
		array3 = new ArrayIndexedCollection<>(6);
		array3.add("Oslo");
		array3.add("Stockholm");
		array3.add("Helsinki");
		array3.add("Reykjavik");
	...
	public void testArrayInsertReallocate() {
		array3 = new ArrayIndexedCollection<>(4);
		array3.add("Oslo");
		array3.add("Stockholm");
		array3.add("Helsinki");
		array3.add("Reykjavik");
		array3.insert("London", 3);
		array3.add("Copenhagen");
		assertEquals(6, array3.size());
		assertEquals("London", array3.get(3));
    ...
    public void testElementsGetter() {
        array3 = new ArrayIndexedCollection<>();
        array4 = new ArrayIndexedCollection<>();
        array3.add("Oslo");
        array3.add("Stockholm");
        array3.add("Copenhagen");
        array4.add("Helsinki");
